...
foreach($chatlist as $k => $v) {?>
		...
		<div id="audit_<?php echo $v['chatid']?>" class="talk  public member">		<span>
			...
			<?php } ?>
		</span>		<div class="talk_name"><a href="javascript:void(0)" class="u_mor" rid="224" uid="4405"><?php echo $v['chatname']?></a><a class="time"><?php echo date("[H:i]", $v['ctime'])?></a>
		<?php if($v['status'] == 0 ) { ?>
			<a id="chataudit" href="javascript:void(0)" onclick="chataudit(<?php echo $v['chatid']?>,1)">审核消息</a>
		<?php } ?>

		</div>		<div class="clear"></div>		<div class="talk_hua"><p><?php
