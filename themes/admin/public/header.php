...
<link href="<?php echo base_url($cfg['tpl_admin'])?>/css/public.css" rel="stylesheet" type="text/css">
<link href="<?php echo base_url($cfg['comm'])?>/js/jBox/Skins/Blue/jbox.css" rel="stylesheet" type="text/css">
